...
$usermessage = "Gracias por contactarnos,actualmente estamos buscando personal, que gusto que desees unirte a nuestro gran equipo.
...
Curso de reentrenamiento (En caso de poseer)
No poseer antecedentes penales o judiciales
Disponibilidad completa.

Si cumples con estos requisitos, por favor responde a este correo electrónico con la siguiente documentación: 
Hoja de vida, cédula y certificado de votación, Carné del Ministerio de Gobierno, Certificado del Curso de Re-entrenamiento, Licencia de conducir, Acta de grado, Certificados laborales, Diplomas de cursos realizados, Certificado de antecedentes penales,Certificado médico que acredite excelente salud, física y mental (otorgado por la Red de Salud Pública del Ecuador).
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "Gracias. <strong>$name_contact</strong>,<br> Tu mensaje ha sido enviado, en tu correo recibirás las instrucciones y requisitos de aplicación .";
	echo "</div>";
